...
const DEFAULT_PLAN_FEATURES = {
  ...
  basic: {
    name:    "Basic",
    description: "Mobile app + core CRM for small teams",
  ...
  pro: {
    name:    "Pro",
    description: "Communication suite + AI transcription for growing teams",
  ...
  advance: {
    name:    "Advance",
    description: "Full feature set with the highest limits",
    ...
    maxGoogleAccounts: 5,
    maxStorageMB: 51200,
    transcriptionsPerMonth: 15000,
    summariesPerMonth: 15000,
  ...
  enterprise: {
    name:    "Enterprise",
    description: "Fully customised for large organisations — contact us",
    price:   { monthly: 0, yearly: 0 },
    color:   "#0E7490",
    custom:  true,
    maxAdmins: 999,
    ...
    maxStorageMB: 512000,
    transcriptionsPerMonth: 999999,
    summariesPerMonth: 999999,
    voiceBotPerMonth: 999999,
    recordingEnabled: true,
